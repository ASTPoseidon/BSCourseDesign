    ...
    <div class="row clearfix" style="margin-top: 30px;padding-left: 20px">
        <div class="col-md-12 column">
            ...
            <form role="form" method="post" onsubmit="return check()"
                  action="${pageContext.request.contextPath}/sendMessageServlet">
                <input type="hidden" name="sno" value="<%=request.getParameter("sno")%>">
                <input type="text" name="title" class="help_message_title" placeholder="输入问题主题描述"
                       required="required">
                <div class="form-group">
                    <textarea id="message" class="content" name="content" placeholder="输入问题详细描述"

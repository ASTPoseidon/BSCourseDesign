        ...
        <div class="col-md-6">
            <div class="index_rctx" id="area_one">
                <h5 class="index_title">
                    ...
                    <span class="more"><a href="${pageContext.request.contextPath}/studenthelp" class="right_more"
                                          target="_blank">更多</a></span>
                </h5>
                <c:if test="${!empty helpList}">
                    <c:forEach items="${helpList}" var="elem">
                        <a class="list-group-item"
                           href="${pageContext.request.contextPath}/searchhelp?id=${elem.getId()}" target="_blank">
        ...
        <div class="col-md-6">
            <div class="index_rctx" id="area_two">
                <h5 class="index_title">
                    ...
                    <span class="more"><a href="${pageContext.request.contextPath}/newcourse" class="right_more"
                                          target="_blank">更多</a></span>
                </h5>
                <c:if test="${!empty newcourse}">
                    <c:forEach items="${newcourse}" var="course">
                        <a class="list-group-item"
                           href="${pageContext.request.contextPath}/searchnew?cno=${course.getCno()}" target="_blank">
                        <span class="title_help">
                                ${course.getCname()}
                        </span>
                            <span class="sno_help">

        ...
        <div class="col-md-4">
            <div class="index_rctx" id="area_one">
                <h5 class="index_title">
                    ...
                    <span class="more"><a href="${pageContext.request.contextPath}/course_table" class="right_more"
        ...
        <div class="col-md-4">
            <div class="index_rctx" id="area_three">
                <h5 class="index_title">
                    ...
                    <span class="more"><a href="${pageContext.request.contextPath}/gradelist" class="right_more"
                                          target="_blank">更多</a></span>
                </h5>
                <div class="list-group">

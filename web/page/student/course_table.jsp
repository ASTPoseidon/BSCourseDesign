...
<style>
    ...
    .jie-item {
        height: 100px;
        border-bottom: 0.5px solid #b7bec3;
        line-height: 100px;
        text-align: center;
        font-size: 20px;
        font-weight: bolder;
    ...
    .item-class {
        ...
        height: 200px;
        text-align: center;
        border-top: 0.3px solid #b7bec3;
        border-bottom: 0.3px solid #b7bec3;
    }
...
<div class="container padding-150" id="body">
    <div class="row" style="padding-top: 60px;padding-left:25px;">
        ...
        <div class="col-md-8 column">
            <div class="new_course_search_div">
                ...
                <button type="button"
                        class="btn btn-default search_btn" onclick="search()">查看课表
                </button>
            </div>
        </div>
    </div>
    ...
    <div class="row main" id="table" style="display: none;">
        <h3 class="title">2022-2023学年第一学期</h3>
        <div class="header">
